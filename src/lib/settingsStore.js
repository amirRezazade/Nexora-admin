...
const KEY = 'nova-store-settings';

export const SETTINGS_DEFAULTS = {
  general: {
    storeName: 'Nova Store',
    storeEmail: 'hello@novastore.com',
    supportPhone: '+49 69 5550 1200',
    storefrontUrl: 'https://novastore.com',
    description:
      'Considered everyday essentials — footwear, apparel, audio and home goods, chosen for how they wear over years rather than seasons.',
    currency: 'USD',
