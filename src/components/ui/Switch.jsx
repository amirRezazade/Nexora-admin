  ...
  return (
    <div className={cn('flex items-start justify-between gap-4', className)}>
      ...
      <button
        ...
        className={cn(
          'relative inline-flex h-5 w-9 shrink-0 items-center rounded-pill border border-transparent transition-colors duration-200 ease-out',
      ...
      >
        <span
          aria-hidden
          className={cn(
            'pointer-events-none absolute top-0.5 inline-block h-4 w-4 rounded-full bg-white shadow-sm transition-[inset-inline-start] duration-200 ease-out',
