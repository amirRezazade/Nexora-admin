...
const LEGACY_STORAGE_KEY = "nexora-locale";
...
export function translate(locale, key, vars) {
  ...
  const raw = lookup(table, key) ?? lookup(extraTable, key) ?? lookup(messages.en, key) ?? lookup(extra.en, key) ?? key;
...
export function I18nProvider({ children }) {
  ...
  const value = useMemo(() => ({ locale, dir: locale === "fa" ? "rtl" : "ltr", setLocale, t }), [locale, setLocale, t]);
