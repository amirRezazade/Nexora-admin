...
export default function AnalyticsPage() {
  ...
  const exportReport = () => {
    downloadCSV(`nova-analytics-${range}-${new Date().toISOString().slice(0, 10)}.csv`, data.series, [
      { header: "Date", value: (r) => r.date },
      { header: "Revenue", value: (r) => r.revenue.toFixed(2) },
      { header: "Orders", value: (r) => r.orders },
      { header: "Units", value: (r) => r.units },
    ]);
    dispatch(toast.success("Export ready", "Your analytics report was downloaded as CSV."));
  };
