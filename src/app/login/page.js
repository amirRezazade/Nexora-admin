      ...
      <form onSubmit={submit} noValidate className="flex flex-col gap-4">
        ...
        <Input
          ...
          action={
            <Link
              ...
              className="text-caption font-medium text-brand-text underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
            >
              {t('auth.forgot')}
            </Link>
          }
        ...
        <div className="-mt-2 flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded text-caption font-medium text-ink-2 transition-colors hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
        ...
        <Alert tone="info" icon={Info} className="mt-2">
          <span className="block">
            {t('auth.demo', { email: DEMO_CREDENTIALS.email, password: DEMO_CREDENTIALS.password })}
          </span>
        </Alert>
      </form>
    </AuthLayout>
