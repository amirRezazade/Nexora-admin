...
export default function NotificationsPage() {
  ...
  const dayLabel = (key) =>
    key === today ? t('common.today') : key === yesterday ? t('common.yesterday') : new Date(key).toLocaleDateString(locale === 'fa' ? 'fa-IR' : 'en-US', { weekday: 'long', month: 'short', day: 'numeric' });
      ...
      <Card className="flex flex-col">
        ...
        {status === 'failed' ? (
          ...
          <EmptyState
            ...
            description={
              unreadOnly
                ? t('notificationsPage.nothingUnreadHint')
                        ...
                        <div className="flex items-start gap-3 px-5 py-4 transition-colors hover:bg-surface-2 sm:px-6">
                          ...
                          <Link href={n.href} className="min-w-0 flex-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand rounded">
                            <span className="flex flex-wrap items-center gap-2">
                              ...
                              <Badge tone="outline" size="sm">{catLabel}</Badge>
                              {!n.read && (
                          ...
                          <IconButton
                            ...
                            label={n.read ? t('notificationsPage.markUnread') : t('notificationsPage.markRead')}
