  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      >
        <div className="mt-3 flex items-center gap-3">
          ...
          <span className="text-body-sm text-ink-2">
            average across {number(state.counts?.all || 0)} reviews
          </span>
        </div>
      </PageHeader>
      ...
      <Card className="flex flex-col">
        ...
        {state.status === 'failed' ? (
          <ErrorState title={t('reviewsPage.loadError')} description="Please try again." onRetry={load} />
          ...
          <EmptyState
            ...
            description={
              hasFilters || tab !== 'all'
                ...
                : 'Reviews appear here once customers start leaving feedback.'
            }
            action={
              (hasFilters || tab !== 'all') && (
