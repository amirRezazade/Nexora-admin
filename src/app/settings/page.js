      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Input label={t('settingsPages.storeName')} value={form.storeName} onChange={patch('storeName')} required />
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Input label={t('settingsPages.storefrontUrl')} type="url" value={form.storefrontUrl} onChange={patch('storefrontUrl')} />
          </div>
