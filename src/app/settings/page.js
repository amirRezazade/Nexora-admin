...
export default function GeneralSettingsPage() {
  ...
  return (
    <SettingsLayout title={t("settings.general")} description={t("settingsPages.generalHint")} dirty={dirty} onSave={save}>
      <Card>
        <CardHeader title={t("settingsPages.storeDetails")} />
        <CardBody className="flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Input label={t("settingsPages.storeName")} value={form.storeName} readOnly disabled hint={t("settingsPages.lockedHint")} />
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Input label={t("settingsPages.storefrontUrl")} type="url" value={form.storefrontUrl} readOnly disabled hint={t("settingsPages.lockedHint")} className="font-mono text-body-sm" />
          </div>
